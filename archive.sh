...
lipo build/openssl/build_*/lib/libssl.4.dylib -create -o output/lib/libssl.4.dylib
lipo build/openssl/build_*/lib/libcrypto.4.dylib -create -o output/lib/libcrypto.4.dylib
